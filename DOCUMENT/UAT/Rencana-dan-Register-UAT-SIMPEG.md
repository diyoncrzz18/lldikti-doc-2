...
| UAT-CUT-31-09 | Konfigurasi cuti | Simpan perubahan chain satu pegawai dan jalankan backfill tanpa alasan; lalu coba PYBMC Global dan penerapan chain ke unit tanpa alasan | Dua aksi pertama diterima dan tetap teraudit; dua aksi massal ditolak dengan validasi alasan wajib | Request/response, screenshot field, audit before/after, test PostgreSQL |
