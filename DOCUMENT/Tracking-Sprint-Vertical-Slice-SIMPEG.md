...
|---|---|---|---|---|
| 15.1 | Penyelarasan cuti: Atasan Langsung, tahap ganda aktor sama, alasan konfigurasi opsional/wajib berbasis dampak, permohonan pembatalan tersendiri yang menahan approval dan diputus Admin Kepegawaian, revisi, penangguhan final, dan formulir | Konfigurasi chain, approval engine, notifikasi, ledger reservasi setuju/tolak, dokumen QR | Feature/unit test PostgreSQL, audit, browser smoke, review, UAT | Belum Direncanakan |
