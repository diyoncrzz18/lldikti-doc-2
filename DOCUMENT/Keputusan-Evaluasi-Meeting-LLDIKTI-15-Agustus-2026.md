...
1. Dokumen pendukung dan nomor dokumen persetujuan bersifat opsional. Bila dokumen diberikan, validasinya ketat dan file disimpan privat.
2. Setiap entri cuti manual baru wajib memiliki snapshot total **2–10 tahap**: **0–8 Verifikator**, tepat satu **Kepala Bagian**, lalu tepat satu **PYBMC** sebagai tahap final.
3. Jenis tahap hanya `verifier`, `kepala_bagian`, dan `pybmc`; hasilnya diturunkan sistem menjadi `verified`, `approved`, dan `final_approved`. Admin tidak memilih hasil tahap.
