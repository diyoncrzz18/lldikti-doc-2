...
Pengajuan eligible, saldo/riwayat sendiri, approval active assignment dan proof otomatis PATEN. Konfigurasi/manual/keputusan cancellation RBAC + scope/state/ledger/lock/audit; AC-RBAC-PATEN, AC-CUTI-MANUAL, AC-CUTI-CANCEL.
