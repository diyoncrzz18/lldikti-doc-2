...
> **Addendum 2 September 2026:** Super Admin adalah konfigurasi awal, bukan allowlist permission fitur. Bukti baru wajib menguji permission matrix dinamis dan Switch Role ke target yang lebih rendah; hanya role asli Super Admin/Admin Kepegawaian dengan `users.switch_role` dapat memulai.
